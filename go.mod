...
require (
	...
	github.com/prometheus-operator/prometheus-operator/pkg/client v0.77.2 // indirect
...
replace (
	...
	github.com/thanos-io/thanos => github.com/thanos-io/thanos v0.0.0-20240723122114-639bf8f21649
