...
const (
	...
	PaodinDefaultIngesterRetentionPeriod = "3h"
)
...
type Options struct {
	...
	DefaultIngesterRetentionPeriod string `json:"defaultIngesterRetentionPeriod,omitempty" yaml:"defaultIngesterRetentionPeriod,omitempty"`
...
func (o *Options) Validate() []error {
	...
	if _, err := time.ParseDuration(o.DefaultIngesterRetentionPeriod); err != nil {
...
func (o *Options) ApplyTo(options *Options) {
	...
	if o.DefaultIngesterRetentionPeriod != "" {
...
func (o *Options) AddFlags(fs *pflag.FlagSet, c *Options) {
	...
	fs.StringVar(&c.DefaultIngesterRetentionPeriod, "defaultIngesterRetentionPeriod", PaodinDefaultIngesterRetentionPeriod, "Paodin default ingester retention period. (default 2h)")
