...
const (
	...
	PaodinDefaultTenantPerIngestor       = 3
...
type Options struct {
	...
	DefaultTenantPerIngestor       int    `json:"defaultTenantPerIngestor,omitempty" yaml:"defaultTenantPerIngestor,omitempty"`
...
func NewOptions() *Options {
	return &Options{
		...
		DefaultTenantPerIngestor:       PaodinDefaultTenantPerIngestor,
...
func (o *Options) ApplyTo(options *Options) {
	...
	if o.DefaultTenantPerIngestor != 0 {
		options.DefaultTenantPerIngestor = o.DefaultTenantPerIngestor
	}
...
func (o *Options) AddFlags(fs *pflag.FlagSet, c *Options) {
	...
	fs.IntVar(&c.DefaultTenantPerIngestor, "defaultTenantPerIngestor", PaodinDefaultTenantPerIngestor, "Paodin default tenant count per ingestor. (default 3)")
