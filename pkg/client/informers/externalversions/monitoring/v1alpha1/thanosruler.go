...
type ThanosRulerInformer interface {
	...
	Lister() v1alpha1.ThanosRulerLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MonitoringV1alpha1().ThanosRulers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MonitoringV1alpha1().ThanosRulers(namespace).Watch(context.TODO(), options)
			},
		},
		&monitoringv1alpha1.ThanosRuler{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *thanosRulerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&monitoringv1alpha1.ThanosRuler{}, f.defaultInformer)
}

func (f *thanosRulerInformer) Lister() v1alpha1.ThanosRulerLister {
	return v1alpha1.NewThanosRulerLister(f.Informer().GetIndexer())
}
