...
var tenantsResource = schema.GroupVersionResource{Group: "monitoring", Version: "v1alpha1", Resource: "tenants"}

var tenantsKind = schema.GroupVersionKind{Group: "monitoring", Version: "v1alpha1", Kind: "Tenant"}
