...
var alertingrulesResource = schema.GroupVersionResource{Group: "monitoring", Version: "v1alpha1", Resource: "alertingrules"}

var alertingrulesKind = schema.GroupVersionKind{Group: "monitoring", Version: "v1alpha1", Kind: "AlertingRule"}
