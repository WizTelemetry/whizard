...
var agentsResource = schema.GroupVersionResource{Group: "monitoring", Version: "v1alpha1", Resource: "agents"}

var agentsKind = schema.GroupVersionKind{Group: "monitoring", Version: "v1alpha1", Kind: "Agent"}
