...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BucketGC) DeepCopyInto(out *BucketGC) {
	*out = *in
	if in.Enable != nil {
		in, out := &in.Enable, &out.Enable
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BucketGC.
func (in *BucketGC) DeepCopy() *BucketGC {
	if in == nil {
		return nil
	}
	out := new(BucketGC)
